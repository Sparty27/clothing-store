<div class="static">
    @if ($opened)
    <div class="fixed top-[40px] right-[25px] z-[45]" wire:poll.1s="update">
        @foreach ($alerts as $key => $alert)
        <div class="alert z-[45] flex justify-between @if ($alert['style'] ?? false) {{ " alert-{$alert['style']}" }} @endif shadow-lg mb-2 ">
            @if ($alert['icon'] ?? false)
