        ...
        @foreach($this->orders as $order)
            <div class="p-3 rounded-xl shadow-lg border-gray-200 border-[1px] mt-6">
                ...
                <div>
                    ...
                    <div class="bg-white dark:bg-[#282828] flex items-center gap-2 mt-3 p-2" wire:key="{{ $orderProduct->id }}">
                        ...
                        <div class="text-gray-500 dark:text-white w-full max-sm:text-xs">
                            <h3 class="font-bold text-black dark:text-primary line-clamp-2">{{ $orderProduct->product->name }}</h3>
                            <div class="my-1">
                                <span class="">Артикул: {{ $orderProduct->product->article }}</span>
                            </div>
                            <div class="">
                                <span class="">Розмір: <span class="font-bold text-black dark:text-primary">{{ $orderProduct->size->name }}</span></span>
                            </div>
                        </div>
